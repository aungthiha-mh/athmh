...
#include "node_tuto/demoAction.h"
#include <iostream>
#include <sstream>
...
protected:
	ros::NodeHandle nh;
	actionlib::SimpleActionServer<node_tuto::demoAction> as;

	node_tuto::demoFeedback feedback;
	node_tuto::demoResult result;
...
public:
	...
	void executeCB(const node_tuto::demoGoalConstPtr &goal)
	{
